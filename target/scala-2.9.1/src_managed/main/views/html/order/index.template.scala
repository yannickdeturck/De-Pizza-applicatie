...
"""),_display_(Seq[Any](/*5.2*/main(Messages("order.index.title"))/*5.37*/ {_display_(Seq[Any](format.raw/*5.39*/("""
	...
	<a class="btn" href=""""),_display_(Seq[Any](/*12.24*/controllers/*12.35*/.routes.PizzaController.index)),format.raw/*12.64*/(""""><i class="icon-adjust"></i> """),_display_(Seq[Any](/*12.95*/Messages("order.index.pizzas.text"))),format.raw/*12.130*/("""</a>
